...
function ResetPassword() {
  ...
  const { code, password } = useSelector(state => state.reset.inputsPage2ResetPassword);
  const { isPasswordHidden, isLoadingResetPassword, isCodeSend, isResetSucces } = useSelector(state => state.reset);
